...
The user can choose a sport and time range when he is available. Based on location and the previous parameters, they will be mapped with other users on app. Use case is to find a sports partner with similar availability and skill level.
