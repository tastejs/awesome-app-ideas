...
This app takes into account of all the vegetables, spices and other products in your pantry and refrigerator. Then, based on that data collected, it suggests you of all the items that can be made at home. Also provides you with the instructions as how to cook a specific item with it's recipe.
